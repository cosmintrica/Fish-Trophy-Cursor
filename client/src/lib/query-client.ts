...
export const queryKeys = {
  ...
  // New Generalized Forum Context (RPC get_forum_context)
  forumContext: (slug?: string, parentSlug?: string, expectedType?: string, parentType?: string) =>
    ['forum-context', slug || null, parentSlug || null, expectedType || null, parentType || null] as const,
}
