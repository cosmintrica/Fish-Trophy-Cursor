        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="absolute top-4 right-4">
            <button
              ...
              className="bg-white hover:bg-gray-50 text-gray-700 px-4 py-2 rounded-lg shadow-lg border border-gray-200 transition-all duration-200 hover:shadow-xl flex items-center gap-2"
            >
          ...
          <div className="mb-12">
            <div className="flex items-center justify-center gap-4 mb-6">
              ...
              />
              <Fish className="w-16 h-16 text-gray-600 hidden" />
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 mb-8 border border-gray-100">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-6 border border-blue-200">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Recorduri de Pescuit</h3>
                <p className="text-gray-600 text-sm">Înregistrează și urmărește recordurile tale de pescuit</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-6 border border-green-200">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Hărți Interactive</h3>
                <p className="text-gray-600 text-sm">Explorează locațiile de pescuit din România</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-6 border border-purple-200">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Comunitate</h3>
                <p className="text-gray-600 text-sm">Conectează-te cu alți pescari pasionați</p>
              </div>
            </div>

            {/* Subscribe form */}
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Vrei să fii primul care află când site-ul este gata?</h3>

              {isSubscribed ? (
                <div className="flex items-center justify-center gap-2 text-green-600 bg-green-50 rounded-lg p-4 border border-green-200">
                  <CheckCircle className="w-5 h-5" />
                  <span className="font-medium">Te-ai abonat cu succes! Mulțumim!</span>
                </div>
              ) : (
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div className="flex gap-4 pt-4">
                  ...
                  <button
                    ...
                    className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-2xl font-medium shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {isLoggingIn ? (
                      <>
                        <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin"></div>
