...
Pentru o analiză mai detaliată despre această problemă și cum să o eviți în viitor, vezi: [`docs/issues/SUPABASE_INSERT_SELECT_RLS_TRAP.md`](../SUPABASE_INSERT_SELECT_RLS_TRAP.md)
