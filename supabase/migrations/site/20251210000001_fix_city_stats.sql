-- =============================================
-- Migration: Fix city_stats GROUP BY error
-- =============================================
-- Fixes the "column city_name does not exist" error by using CTE
-- =============================================

-- Drop and recreate function with fixed city_stats
...
BEGIN
  ...
  -- Romanian cities stats - use CTE to fix GROUP BY issue
